...
import {LightingPresetCard} from '../../../shared/design-system/guestCards';
import {BrightnessRail} from '../../../shared/design-system/controls/BrightnessRail';
import {
  Chip,
  ConfirmationModal,
  GlassCard,
...
import type {LightingColor, LightingPreset, LightingSettings} from '../../../domain/resort/types';
...
export function AmbienceConsole() {
  const [settings, setSettings] = useGuestMemory<LightingSettings>(
    guestMemoryKeys.lightingSettings,
      ...
      <GlassCard style={styles.sectionCard}>
        <View style={styles.timerHeader}>
          ...
          <Switch
            ...
            thumbColor={settings.timerEnabled ? palette.emerald : palette.textSecondary}
            trackColor={{
