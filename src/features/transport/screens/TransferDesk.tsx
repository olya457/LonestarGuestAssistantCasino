...
import {TaxiCategoryCard} from '../../../shared/design-system/guestCards';
import {
  Chip,
  ConfirmationModal,
  GlassCard,
...
import type {TaxiCategoryId, TaxiDraft} from '../../../domain/resort/types';
...
export function TransferDesk() {
  const [draft, setDraft] = useGuestMemory<TaxiDraft>(
    guestMemoryKeys.taxiDraft,
    defaultTaxiDraft,
  );
