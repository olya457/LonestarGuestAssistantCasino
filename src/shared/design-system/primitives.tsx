...
import {palette, layoutUnits} from '../theme/palette';
...
export function AppLogo({size = 88}: {size?: number}) {
  return (
    <View
      ...
      <Image source={require('../../assets/guest-atlas/system/emerald_monogram_glow.png')} style={styles.logoImage} />
...
const styles = StyleSheet.create({
  ...
  screenContent: {
    paddingHorizontal: layoutUnits.screen,
  ...
  card: {
    ...
    borderRadius: layoutUnits.cardRadius,
    borderWidth: 1,
